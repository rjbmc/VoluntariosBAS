        ...
        try {
            ...
            try (PreparedStatement ps = conn.prepareStatement(sql);
                ...
                while(rs.next()){
                    ...
                    // 1. Campo Title (uniÃ³n de Nombre y Apellidos)
                    ...
                    if (cp_str != null && !cp_str.trim().isEmpty()) {
                        try {
                            ...
                            // Si el CP no es un nÃºmero vÃ¡lido, no se envÃ­a a SharePoint.
                        }
                    }
            ...
            jsonResponse.addProperty("message", "SincronizaciÃ³n de Voluntarios completada con Ã©xito.");
            LogUtil.logOperation(conn, "SYNC_VOLUNTARIOS", (String) session.getAttribute("usuario"), "SincronizaciÃ³n masiva de Voluntarios completada.");

        } catch (Exception e) {
            e.printStackTrace();
            response.setStatus(HttpServletResponse.SC_INTERNAL_SERVER_ERROR);
            jsonResponse.addProperty("success", false);
            jsonResponse.addProperty("message", "Error en la sincronizaciÃ³n de Voluntarios: " + e.getMessage());
        } finally {
