        ...
        try {
            ...
            try (PreparedStatement ps = conn.prepareStatement(sql);
                ...
                while(rs.next()){
                    ...
                    // --- VERSIÃ“N FINAL: Todos los campos reactivados ---
            ...
            jsonResponse.addProperty("message", "Â¡Ã‰xito! SincronizaciÃ³n de CampaÃ±as (con todos los campos) completada.");
            LogUtil.logOperation(conn, "SYNC_CAMPANAS_FINAL", (String) session.getAttribute("usuario"), "SincronizaciÃ³n de CampaÃ±as (final) completada con Ã©xito.");

        } catch (Exception e) {
            e.printStackTrace();
            response.setStatus(HttpServletResponse.SC_INTERNAL_SERVER_ERROR);
            jsonResponse.addProperty("success", false);
            jsonResponse.addProperty("message", "Error en la sincronizaciÃ³n de CampaÃ±as: " + e.getMessage());
        } finally {
