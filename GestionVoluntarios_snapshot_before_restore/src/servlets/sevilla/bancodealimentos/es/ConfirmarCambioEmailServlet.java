    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try (Connection conn = DatabaseUtil.getConnection()) {
                ...
                if (sqlRowUuid != null) {
                    try {
                        ...
                        if (itemId != null) {
                            ...
                            LogUtil.logOperation(conn, "SP_EMAIL_UPDATE_WARN", usuario, "No se encontrÃ³ item en SP para UUID: " + sqlRowUuid);
                        }
                    } catch (Exception e) {
                    ...
                    LogUtil.logOperation(conn, "SP_EMAIL_UPDATE_WARN", usuario, "No se encontrÃ³ SqlRowUUID para replicar el cambio de email a SharePoint.");
                }

                conn.commit();
                sendJsonResponse(response, true, "Tu direcciÃ³n de correo ha sido actualizada con Ã©xito.", HttpServletResponse.SC_OK);
            } else {
                conn.rollback();
                sendJsonResponse(response, false, "El enlace de confirmaciÃ³n no es vÃ¡lido o ya ha sido utilizado.", HttpServletResponse.SC_BAD_REQUEST);
            }
            ...
            if (e.getErrorCode() == 1062) { // Error de clave duplicada
                 message = "La nueva direcciÃ³n de correo ya estÃ¡ en uso por otro voluntario.";
            } else {
