                ...
                try {
                    ...
                    if (isUpdate) {
                        ...
                        if (itemId != null) {
                            ...
                            LogUtil.logOperation(conn, "SP_CREATE_T_CONT", adminUser, "Se creÃ³ tienda en SP por contingencia: " + codigo);
                        }
                    } else {
                        spData.put(SP_UUID_FIELD, rowUuid);
                        FieldValueSet fieldsToCreate = new FieldValueSet();
                    ...
                    LogUtil.logOperation(conn, "SP_REPLICATION_ERROR", adminUser, "Fallo en replicaciÃ³n de tienda " + codigo + ". Causa: " + e.getMessage());
                    e.printStackTrace();
                }
