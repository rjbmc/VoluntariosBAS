/**
 * Fichero de configuraciÃ³n centralizado para el frontend.
 * Contiene las rutas (endpoints) de todos los servlets de la aplicaciÃ³n.
 */
const AppConfig = {
    // RaÃ­z del contexto de la aplicaciÃ³n en el servidor Tomcat
